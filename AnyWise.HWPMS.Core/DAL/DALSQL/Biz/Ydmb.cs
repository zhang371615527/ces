...
namespace AnyWise.HWPMS.DALSQL
{
    ...
    /// 月度目标表
    /// </summary>
	public class Ydmb : BaseDALSQL<YdmbInfo>, IYdmb
	{
		#region 对象实例及构造函数

		public static Ydmb Instance
		{
			get
			{
				return new Ydmb();
		...
		protected override YdmbInfo DataReaderToEntity(IDataReader dataReader)
		{
			YdmbInfo info = new YdmbInfo();
            ...
            info.Ndmbzb_ID = reader.GetString("Ndmbzb_ID");
        ...
        protected override Hashtable GetHashByEntity(YdmbInfo obj)
		{
		    YdmbInfo info = obj as YdmbInfo;
            ...
            hash.Add("Ndmbzb_ID", info.Ndmbzb_ID);
