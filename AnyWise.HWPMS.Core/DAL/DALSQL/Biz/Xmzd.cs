...
namespace AnyWise.HWPMS.DALSQL
{
    ...
    /// 项目字典
    /// </summary>
	public class Xmzd : BaseDALSQL<XmzdInfo>, IXmzd
	{
		#region 对象实例及构造函数

		public static Xmzd Instance
		{
			get
			{
				return new Xmzd();
		...
		protected override XmzdInfo DataReaderToEntity(IDataReader dataReader)
		{
			XmzdInfo info = new XmzdInfo();
            ...
            info.Xmlb_ID = reader.GetString("Xmlb_ID");
        ...
        protected override Hashtable GetHashByEntity(XmzdInfo obj)
		{
		    XmzdInfo info = obj as XmzdInfo;
