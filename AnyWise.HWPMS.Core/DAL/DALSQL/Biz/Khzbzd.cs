...
namespace AnyWise.HWPMS.DALSQL
{
    ...
    /// 考核指标字典
    /// </summary>
	public class Khzbzd : BaseDALSQL<KhzbzdInfo>, IKhzbzd
	{
		#region 对象实例及构造函数

		public static Khzbzd Instance
		{
			get
			{
				return new Khzbzd();
		...
		public Khzbzd() : base("TB_KHZBZD","ID")
		{
		}
		...
		protected override KhzbzdInfo DataReaderToEntity(IDataReader dataReader)
		{
			KhzbzdInfo info = new KhzbzdInfo();
        ...
        protected override Hashtable GetHashByEntity(KhzbzdInfo obj)
		{
		    KhzbzdInfo info = obj as KhzbzdInfo;
