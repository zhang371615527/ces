...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class SystemTypeCaller : BaseApiService<SystemTypeInfo>, ISystemTypeService
    {
        public SystemTypeCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.SystemType;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<SystemTypeInfo>>.ConvertJson(url);
        //    return result;
        //}
