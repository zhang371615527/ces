...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class JZXSLBCaller : BaseApiService<JZXSLBInfo>, IJZXSLBService
    {
        public JZXSLBCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.JZXSLB;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<JZXSLBInfo>>.ConvertJson(url);
        //    return result;
        //}
