...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class LoginLogCaller : BaseApiService<LoginLogInfo>, ILoginLogService
    {
        public LoginLogCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.LoginLog;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<LoginLogInfo>>.ConvertJson(url);
        //    return result;
        //}
