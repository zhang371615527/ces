...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class YljxfpcsbCaller : BaseApiService<YljxfpcsbInfo>, IYljxfpcsbService
    {
        public YljxfpcsbCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Yljxfpcsb;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<YljxfpcsbInfo>>.ConvertJson(url);
        //    return result;
        //}
