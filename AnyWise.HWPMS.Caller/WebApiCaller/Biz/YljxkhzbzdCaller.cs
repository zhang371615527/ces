...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class YljxkhzbzdCaller : BaseApiService<YljxkhzbzdInfo>, IYljxkhzbzdService
    {
        public YljxkhzbzdCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Yljxkhzbzd;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<YljxkhzbzdInfo>>.ConvertJson(url);
        //    return result;
        //}
