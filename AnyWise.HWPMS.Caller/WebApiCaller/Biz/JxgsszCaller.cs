...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class JxgsszCaller : BaseApiService<JxgsszInfo>, IJxgsszService
    {
        public JxgsszCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Jxgssz;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<JxgsszInfo>>.ConvertJson(url);
        //    return result;
        //}
