...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class JxgsszzbCaller : BaseApiService<JxgsszzbInfo>, IJxgsszzbService
    {
        public JxgsszzbCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Jxgsszzb;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<JxgsszzbInfo>>.ConvertJson(url);
        //    return result;
        //}
