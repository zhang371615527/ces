...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class JxcsbCaller : BaseApiService<JxcsbInfo>, IJxcsbService
    {
        public JxcsbCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Jxcsb;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<JxcsbInfo>>.ConvertJson(url);
        //    return result;
        //}
