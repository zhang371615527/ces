...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class YljxfpszzbCaller : BaseApiService<YljxfpszzbInfo>, IYljxfpszzbService
    {
        public YljxfpszzbCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Yljxfpszzb;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<YljxfpszzbInfo>>.ConvertJson(url);
        //    return result;
        //}
