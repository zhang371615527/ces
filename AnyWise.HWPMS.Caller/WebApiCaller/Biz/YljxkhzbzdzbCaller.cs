...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class YljxkhzbzdzbCaller : BaseApiService<YljxkhzbzdzbInfo>, IYljxkhzbzdzbService
    {
        public YljxkhzbzdzbCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Yljxkhzbzdzb;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<YljxkhzbzdzbInfo>>.ConvertJson(url);
        //    return result;
        //}
