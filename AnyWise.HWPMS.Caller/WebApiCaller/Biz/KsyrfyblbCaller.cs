...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class KsyrfyblbCaller : BaseApiService<KsyrfyblbInfo>, IKsyrfyblbService
    {
        public KsyrfyblbCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Ksyrfyblb;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<KsyrfyblbInfo>>.ConvertJson(url);
        //    return result;
        //}
