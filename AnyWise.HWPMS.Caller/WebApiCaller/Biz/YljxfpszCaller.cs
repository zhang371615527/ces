...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class YljxfpszCaller : BaseApiService<YljxfpszInfo>, IYljxfpszService
    {
        public YljxfpszCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Yljxfpsz;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<YljxfpszInfo>>.ConvertJson(url);
        //    return result;
        //}
