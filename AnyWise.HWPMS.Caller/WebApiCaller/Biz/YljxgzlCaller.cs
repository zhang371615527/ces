...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class YljxgzlCaller : BaseApiService<YljxgzlInfo>, IYljxgzlService
    {
        public YljxgzlCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Yljxgzl;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<YljxgzlInfo>>.ConvertJson(url);
        //    return result;
        //}
