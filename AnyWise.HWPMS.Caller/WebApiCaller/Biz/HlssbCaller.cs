...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class HlssbCaller : BaseApiService<HlssbInfo>, IHlssbService
    {
        public HlssbCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.Hlssb;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<HlssbInfo>>.ConvertJson(url);
        //    return result;
        //}
