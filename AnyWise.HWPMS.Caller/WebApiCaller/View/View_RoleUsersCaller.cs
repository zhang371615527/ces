...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class View_RoleUsersCaller : BaseApiService<View_RoleUsersInfo>, iView_RoleUsersService
    {
        public View_RoleUsersCaller()
            : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.View_RoleUsers;
        }
       ...
       #region 示例代码
		...
		//
        //    var result = JsonHelper<List<View_RoleUsersInfo>>.ConvertJson(url);
        //    return result;
        //}
