...
namespace AnyWise.HWPMS.WebApiCaller
{
	...
	/// </summary>
    public class DictTypeCaller : BaseApiService<DictTypeInfo>, IDictTypeService
    {
        public DictTypeCaller() : base()
        {
            this.ConfigurationPath = ApiConfig.ConfigFileName; //Web API配置文件
            this.configurationName = ApiConfig.DictType;
        }
